...
/*
 *   5-Apr-97  PL9
 *  Add code for the non-ftime world.  Outputs elapsed time only..
 *  This module was first gotten from tin v1.3unoff BETA of 6-Feb-97.
 *
 *  Billy Y..
 */
...
#ifdef	HAVE_SYS_TIME_H		/* PL9 added these routines.. */
#include <sys/time.h>
