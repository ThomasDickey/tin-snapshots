...
extern void vWriteFilterArray P_((FILE *fp, int global, struct t_filters *ptr, long theTime));
...
extern int check_article_to_be_posted P_((char *the_article, int art_type, int *lines));
...
extern void add_to_save_list P_((int index, struct t_article *the_article, int is_mailbox, int archive_save, char *path));
