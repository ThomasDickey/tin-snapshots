...
static MapiRecipDesc rdOriginator =
{0L, MAPI_ORIG, (LPSTR) "ONE", NULL};
...
static int
sendMail(char *To, char *Subject, char *Text, BOOL editBeforeSend)
{
...
int
sendmail(LPSTR szFileName, LPSTR szTo, LPSTR szSubject, BOOL fEdit)
{
	int err = 1;
	HANDLE hFile = NULL;
	LPSTR pText = NULL;
