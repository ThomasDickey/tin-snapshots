...
/*  A Bison parser, made from parsdate.y with Bison version GNU Bison version 1.22
  */
...
static const short yyrline[] = { 0,
   136,   137,   140,   149,   153,   156,   161,   173,   179,   186,
   192,   202,   206,   210,   214,   222,   228,   249,   253,   265,
   269,   274,   278,   283,   290,   293,   296,   299,   304,   307
};
...
static const short __far yydefact[] = {     1,
     0,     0,     0,     0,    29,     2,     3,     5,     6,     0,
    20,    27,    25,    30,    22,    28,    26,     0,     0,     7,
    13,    17,    12,     4,    16,     0,     0,    23,    29,    18,
    14,    15,     0,    21,     0,     9,     8,     0,    24,    29,
    19,    11,    10,     0,     0
};
...
static const short __far yypact[] = {-32768,
     4,    -7,     1,    -5,    13,-32768,    25,-32768,-32768,     5,
     7,-32768,-32768,-32768,     6,-32768,-32768,    15,    20,-32768,
    11,-32768,    22,-32768,-32768,    27,    28,-32768,    19,    21,
-32768,-32768,    29,-32768,    30,-32768,-32768,    31,-32768,     0,
-32768,-32768,-32768,    37,-32768
};

static const short __far yypgoto[] = {-32768,
-32768,-32768,-32768,   -23,-32768,-32768,   -28
};
...
static const short __far yytable[] = {    32,
    37,    12,    13,    44,    14,    36,     2,    10,    22,     3,
    11,    43,     4,     5,    26,    28,    42,    14,    15,    16,
    17,    27,    31,    14,    29,    18,    19,    22,    21,    30,
    22,    35,    33,    22,    38,    23,    45,    34,    39,    40,
    41
};

static const short __far yycheck[] = {    23,
    29,     7,     8,     0,     5,    29,     3,    15,     9,     6,
    10,    40,     9,    10,    10,    10,    40,     5,     6,     7,
     8,    15,    12,     5,    10,    13,    14,     9,     4,    10,
     9,    13,     6,     9,    14,    11,     0,    10,    10,    10,
    10
};
...
#define YYEMPTY		-2
#define YYEOF		0
#define YYACCEPT	{free (yyvs); free(yyss); return(0);}
#define YYABORT 	{free (yyvs); free(yyss); return(1);}
...
#endif

#if (__GNUC__ > 1) || defined (__SASC)	/* GNU C and GNU C++ define this.  */
...
/* Month and day table. */
static const TABLE	__far MonthDayTable[] = {
    { "january",	tMONTH,  1 },
    { "february",	tMONTH,  2 },
    { "march",		tMONTH,  3 },
    { "april",		tMONTH,  4 },
...
/* Time units table. */
static const TABLE	__far UnitsTable[] = {
    { "year",		tMONTH_UNIT,	12 },
    { "month",		tMONTH_UNIT,	1 },
...
/* Timezone table. */
static const TABLE	__far TimezoneTable[] = {
