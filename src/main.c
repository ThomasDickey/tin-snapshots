...
#		ifdef NNTP_ONLY
#			ifdef HAVE_COLOR
#				define OPTIONS "acCD:f:g:hH:m:M:nN:PqrRs:SvVwzZ"
#			else /* !HAVE_COLOR */
#				define OPTIONS "cCD:f:g:hH:m:M:nN:PqrRs:SvVwzZ"
#			endif
#		else /* !NNTP_ONLY */
#			ifdef NNTP_ABLE
#				ifdef HAVE_COLOR
...
#			else /* !NNTP_ABLE */
#				ifdef HAVE_COLOR
#					define OPTIONS "acCD:f:hHI:m:M:N:PqRs:SuUvVwzZ"
#				else /* !HAVE_COLOR */
#					define OPTIONS "cCD:f:hHI:m:M:N:PqRs:SuUvVwzZ"
#				endif
#			endif
#		endif
