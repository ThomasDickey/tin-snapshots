...
constext txt_delete_article[] = "Delete article [%s]? (y/n): ";
...
constext txt_help_u[] = "u         toggle display of unthreaded/threaded articles\r\n";
...
constext txt_quit_delete[] = "q)uit, d)elete";
...
constext txt_read_art[] = "Read article> ";
...
constext txt_reading_news_active_file[] = "Reading news active file... ";
...
constext txt_resp_to_poster[] = "Responses have been directed to the poster. Post anyway? (y/n): ";
...
constext txt_thread_page[] = "Thread %d of %d (page %d):  %s";
constext txt_thread_resp_page[] = "Thread %d of %d, Resp %d/%d (page %d):  %s";
