...
static char RCSid[] = "$Id: sprint.c,v 8.2 1993/03/17 02:53:29 panos Exp $" ;
 ...
 * sp points to the next available character in the buffer and
 ...
 * are discarded if the buffer overflows.
 *
	...
	va_list ap ;
{
	...
	boolean_e alternate_form=NO ;
	boolean_e print_sign=NO ;
	boolean_e print_blank=NO ;
	boolean_e adjust_precision=NO ;
	boolean_e adjust_width=NO ;
	bool_int is_negative=NO ;

#ifdef __DECC
	char *conv_p2(), *conv_fp() ;
#else
